...
(* autor Krzysztof Lagodzisnki, reveiwer Franciszek Biel *)
...
(* zgodnie ze specyfikacja - opis funkcji w tresci zadania *)
...
(* po ktorej stronie wzgledem prostej wyznaczonej przez p0 p1 jest p2 *)
        let ktora_strona (p0 : point) (p1 : point) (p2 : point) =
            ...
            if (abs_float (iloczyn_wektorowy) < epsilon) then Srodek else
